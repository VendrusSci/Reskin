 ...
 *
*/
(function(c){c.cluetip={version:"1.2.5",template:'<div><div class="cluetip-outer"><div class="cluetip-inner ui-cluetip-content"></div></div><div class="cluetip-extra"></div></div>',setup:{insertionType:"appendTo",insertionElement:"body"},
		  defaults:{
			  multiple:false,
			  width:275,
			  height:130,
			  ...
			  onHide:function(){},
			  ajaxCache:false,
			  ajaxProcess:function(l){return l=l.replace(/<(script|style|title)[^<]+<\/(script|style|title)>/gm,"").replace(/<(link|meta)[^>]+>/g,"")},
			  ajaxSettings:{dataType:"html"},debug:false}};var B,L={},ia=0,R=0;c.fn.attrProp=c.fn.prop||c.fn.attr;c.fn.cluetip=function(l,r){function S(E,j){var k=E||"";j=j||"";if(typeof j=="object")c.each(j,function(i,d){k+="-"+i+"-"+d});else if(typeof j=="string")k+=j;return k}function T(E,j,k){k="";j=j.dropShadow&&j.dropShadowSteps?+j.dropShadowSteps:
